...
function Navbar() {
    ...
    const {setShowLogin, user, logout, isOwner, axios, setIsOwner}=useContext(AppContext)
  ...
  return (
    ...
    ${location.pathname === '/' && 'bg-light'}`}>
        <Link to='/'>
            <motion.img whileHover={{scale: 1.05}} className='h-8 cursor-pointer' src={assets.logo} alt="logo" />
        </Link>
